...
//========== Определение типа фундамента =======================================//
    ...
    $('#stena1').click(function () {
        Ks =Ks1;
        Nsten=document.getElementById('stena1').value;
        zena();
    });
    ...
    $('#stena3').click(function () {
        Ks = Ks3;
        Nsten=document.getElementById('stena3').value;
        zena();
    });

    $('#stena4').click(function () {
        Ks = Ks4;
        Nsten=document.getElementById('stena4').value;
        zena();
      });
    $('#stena5').click(function () {
        Ks = Ks5;
        Nsten=document.getElementById('stena5').value;
        zena();
    });
    $('#stena6').click(function () {
        Ks = Ks6;
    ...
    $('#stena10').click(function () {
        Ks = Ks10;
        Nsten=document.getElementById('stena10').value;
        zena();
    });
    $('#stena11').click(function () {
        Ks = Ks11;
