...
function sendAjaxForm(result_form, ajax_form, url) {
    $.ajax({
        ...
        success: function(response) { //Данные отправлены успешно
			...
			// block.find('.zakas_form1_title2').show();
           // block.find('.zakas_form1_button').hide();
           // block.find('.zakas_form1_title').hide();
            ...
            block.find('.zena').show();
			 block.find('.zakas_form1_title').hide();
			  block.find('.zakas_form1_title2').show();
            block.find('.zakas_form1_button').hide();
			block.find('.popup_block').hide();
			block.find('.popup_block').fadeOut(function();
			block.find('.#fade').fadeOut(function();
