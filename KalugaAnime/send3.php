...
if (
    isset($_POST['name_client3']) && !empty($_POST['name_client3']) &&
    isset($_POST['tel_client3']) && !empty($_POST['tel_client3'])) {

 $name_client3 = substr(htmlspecialchars(trim($_POST['name_client3'])), 0, 1000);
 $tel_client3 = substr(htmlspecialchars(trim($_POST['tel_client3'])), 0, 1000000);

 $to = 'alexandr.tupichenkov@yandex.ru';
 $title = 'Новый заказ на окно со скидкой';
 $message = "
        Имя: $name_client3
        Телефон : $tel_client3
