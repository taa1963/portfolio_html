...
$('#calculator_floor1').on('click', function() {
 ...
 function floor1() {
  ...
  let  floor1 = document.getElementById('calculator_floor1');

  let parent1 = floor1.closest('.calculator_floor');

  let cl= parent1.classList.contains('flop_add');
...
$('#calculator_floor2').on('click', function() {
  ...
  window.calculator_floor2f=calculator_floor2f;

  function calculator_floor2f1(){
    var  floor2 = document.getElementById('calculator_floor2');
  ...
  window.calculator_floor2f1=calculator_floor2f1;
...
$('#calculator_floor3').on('click', function() {
  ...
  window.calculator_floor3f=calculator_floor3f;
...
$('#calculator_floor4').on('click', function() {
  ...
  window.calculator_floor4f=calculator_floor4f;
...
window.calculator_floor5ff=calculator_floor5ff;
...
window.disainprise=disainprise;
  ...
  $('#clear_sait').on('click', function() {
   ...
   window.clear_sait1=clear_sait1;
...
$('#clear_adapt1').on('click', function() {
  ...
  window.clear_adapt1=clear_adapt1;
...
window.clear_adapt2=clear_adapt2;
...
//======================= Вычисление общей цены бор на блоке "Адаптация верстки"  2 блок==================//
   ...
   window.adatp_nprise=adatp_nprise;
...
//======================= "Разрабока сайтов" ---"3 Этап - Лицензирование, хостинг и домен"==================//
  ...
  window.clear_lizen1=clear_lizen1;
...
window.clear_domen=clear_domen;
...
function lizense_prise(){
 ...
 window.lizense_prise=lizense_prise;
...
//======================= "Разрабока сайтов" ---"4 Этап - Функционал и разделы сайта"==================//
  ...
  window.clear_rasdel=clear_rasdel;
...
window.clear_zakaz=clear_zakaz;
...
window.clear_oplata=clear_oplata;
...
window.clear_integr=clear_integr;
...
function rasdel_prise(){
 ...
 function btn2f(element){
  disprise=0;
  dis1text='';

   disprise=element.value;

   var txt=element.getAttribute('data-name');
   dis1text=dis1text+txt+';';
    saitprisef();
   $('.popup-fade2').fadeOut();
   return false;
...
window.rasdel_prise=rasdel_prise;
...
//======================= Очистить все на блоке  "Отдельные виды работ по техподдержке сайтов========================\\

$('#clear_texpod').on('click', function() {
  clear_texpod();  
 
  }); 

  function clear_texpod(){
    var content1 = document.getElementsByName('tehn2');
   for(i=0; i < content1.length; i++){
   ...
   window.clear_texpod=clear_texpod;
...
window.clear_contentf=clear_contentf;
...
$('#clear_content2').on('click', function() {
  ...
  window.clear_content2f=clear_content2f;
...
$('#clear_hostd').on('click', function() {
  ...
  window.clear_hostdf=clear_hostdf;
...
$('#clear_tarif').on('click', function() {
  ...
  window.clear_tariff=clear_tariff;
...
$('#clear_konsul').on('click', function() {
  ...
  window.clear_konsulf=clear_konsulf;
...
$('#clear_tarif3').on('click', function() {
  ...
  window.clear_tarif3f=clear_tarif3f;
...
$('#clear_jnd1').on('click', function() {
  ...
  window.clear_jnd1f=clear_jnd1f;
...
$('#clear_googl').on('click', function() {
  ...
  window.clear_googlf=clear_googlf;
...
$('#clear_settings').on('click', function() {
  ...
  window.clear_settingsf=clear_settingsf;
...
$('#clear_zajv').on('click', function() {
  ...
  window.clear_zajvf=clear_zajvf;
...
$('#clear_tarifb').on('click', function() {
 clear_tarifbf();
  ...
  window.clear_tarifbfunc=clear_tarifbfunc;
...
$('#clear_korob').on('click', function() {
  ...
  window.clear_korobf=clear_korobf;
...
function all_prisef(){
  ...
  var textArea = document.getElementById('itogmail');
  textArea.value='';

  let text='Цена заказа:'+itog_price;
  textArea.value += text + '\n';

 

 //========  Разработка сайта         ========///
  if ((dis1text. trim() !== '')||(adapt1text. trim() !== '')||(bitr1text. trim() !== '')||(ssl1text. trim() !== '')
  ||(host1text. trim() !== '')||(dome1text. trim() !== ''))
  {
  
    textArea.value += 'Разработка сайта:' + '\n';
    if (dis1text. trim() !== ''){
      textArea.value += "Варианты дизайна:"+dis1text + '\n';
    }

    if (adapt1text. trim() !== ''){
      textArea.value += "Адаптивная верстка:"+adapt1text + '\n';
    }

    if (bitr1text. trim() !== ''){
      textArea.value += "Подбор лицензии 1С-Bitrix:"+bitr1text + '\n';
    }
    
    if (ssl1text. trim() !== ''){
      textArea.value += "Подбор SSL-сертификата:"+ssl1text + '\n';
    }

    if (host1text. trim() !== ''){
      textArea.value += "Подбор хостинга:"+host1text + '\n';
    }

    if (dome1text. trim() !== ''){
      textArea.value += "Регистрация домена:"+dome1text + '\n';
    }   
  }

//========  Функционал и разделы сайта         ========///
  if ((rasdel1text. trim() !== '')||(modul1text. trim() !== '')||(magas1text. trim() !== '')||(card1text. trim() !== '')
  ||(zakaz1text. trim() !== '')||(dostav1text. trim() !== '')||(oplata1text. trim() !== '')||(interg1text. trim() !== '')||(texn1text. trim() !== ''))
  {
    textArea.value += 'Функционал и разделы сайта:' + '\n';
    if (rasdel1text. trim() !== ''){
      textArea.value += "Разделы сайта:"+rasdel1text + '\n';
    }

    if (modul1text. trim() !== ''){
      textArea.value += "Функциональные модули сайта:"+modul1text + '\n';
    }

    if (magas1text. trim() !== ''){
      textArea.value += "Функции интернет-магазина:"+magas1text + '\n';
    }
    
    if (card1text. trim() !== ''){
      textArea.value += "Карточка товара:"+card1text + '\n';
    }

    if (zakaz1text. trim() !== ''){
      textArea.value += "Оформление заказа:"+zakaz1text + '\n';
    }

    if (dostav1text. trim() !== ''){
      textArea.value += "Варианты доставки:"+dostav1text + '\n';
    } 

    if (oplata1text. trim() !== ''){
      textArea.value += "Варианты оплаты:"+oplata1text + '\n';
    }  

    if (texn1text. trim() !== ''){
      textArea.value += "Подготовка технического задания:"+texn1text + '\n';
    }  
  }   


    //========  Наполнение, размещение и техническая поддержка         ========///
  if ((texn2text. trim() !== '')||(content2text. trim() !== '')||(content3text. trim() !== '')||(host3text. trim() !== '')
  ||(tarif1text. trim() !== '')||(konsul1text. trim() !== ''))
  {
    textArea.value += 'Наполнение, размещение и техническая поддержка:' + '\n';

    if (texn2text. trim() !== ''){
      textArea.value += "Отдельные виды работ по техподдержке сайтов:"+texn2text + '\n';
    } 
    if (content2text. trim() !== ''){
      textArea.value += "Наполнение:"+content2text + '\n';
    }
    if (content3text. trim() !== ''){
      textArea.value += "Подготовка контента:"+content3text + '\n';
    }
    if (host3text. trim() !== ''){
      textArea.value += "Размещение на хостинге и домене заказчика:"+host3text + '\n';
    }
    if (tarif1text. trim() !== ''){
      textArea.value += "Тарифные планы:"+tarif1text + '\n';
    }
    if (konsul1text. trim() !== ''){
      textArea.value += "Консультации специалистов:"+konsul1text + '\n';
    }    
  }
     ...
     if (tarif2text. trim() !== '')
     {
       textArea.value += 'SEO оптимизация сайта:' + '\n';
   
       if (tarif2text. trim() !== ''){
         textArea.value += "Тарифные планы:"+tarif2text + '\n';       
       }
      }
    
     //========  Контекстная реклама         ========///
     if ((reklama1text. trim() !== '')||(reklama2text. trim() !== ''))
     {
       textArea.value += 'Контекстная реклама:' + '\n';
   
       if (reklama1text. trim() !== ''){
         textArea.value += "Яндекс.Директ:"+reklama1text + '\n';       
       } 
       if (reklama2text. trim() !== ''){
        textArea.value += "Google AdWords:"+reklama2text + '\n'; 
       } 
      }  
      
       //========   Битрикс24 - внедрение        ========///
     if ((seting1email. trim() !== '')||(zvon1email. trim() !== '')||(tarifb11email. trim() !== '')||(tarifb12email. trim() !== ''))
     {
       textArea.value += ' Битрикс24 - внедрение:' + '\n';
   
       if (seting1email. trim() !== ''){
         textArea.value += "Общие настройки:"+seting1email + '\n';       
       } 
       if (zvon1email. trim() !== ''){
        textArea.value += "Контроль входящих заявок:"+zvon1email + '\n'; 
       } 

       if (tarifb11email. trim() !== ''){
        textArea.value += "Битрикс24 облако:"+tarifb11email + '\n'; 
       } 
       if (tarifb12email. trim() !== ''){
        textArea.value += "Битрикс24 коробка:"+tarifb12email + '\n'; 
       } 
      }    
 ...
 // Закрываем форму заказа  при клике на любом месте кроме формы;
