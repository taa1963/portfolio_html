...
if (
    ...
    isset($_POST['Sb2m']) && !empty($_POST['Sb2m']) &&
    isset($_POST['Zb2m']) && !empty($_POST['Zb2m']) &&
    isset($_POST['name']) && !empty($_POST['name']) &&
    isset($_POST['tel']) && !empty($_POST['tel']) &&
    isset($_POST['mailv']) && !empty($_POST['mailv']))
	{
    $fund2m = substr(htmlspecialchars(trim($_POST['fund2m'])), 0, 1000000);
    $Msten2m = substr(htmlspecialchars(trim($_POST['Msten2m'])), 0, 10000000);
