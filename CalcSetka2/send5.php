...
if (
    isset($_POST['name_client5']) && !empty($_POST['name_client5']) &&
    isset($_POST['tel_client5']) && !empty($_POST['tel_client5'])) {

 $name_client5 = substr(htmlspecialchars(trim($_POST['name_client5'])), 0, 1000);
 $tel_client5 = substr(htmlspecialchars(trim($_POST['tel_client5'])), 0, 1000000);

 $to = 'alexandr.tupichenkov@yandex.ru';
 $title = 'Новый заявка на вызов мастера';
 $message = "
        Имя: $name_client5
        Телефон : $tel_client5
