var Typefundv,TypeFundamentName,GorodPr,NumberBl,TeploPr,DrenagPr;
Typefundv=1;
     ...
     if (GorodPr==1){
       //====Первый блок Сметы=========///        
        ...
        newSection.html(
            ...
            '<td style="width:10%;text-align: center;font-weight: bold;">1</td>\n+'+
            '<td style="width:15%;text-align: center;font-weight: bold;"><span id="Zblock1sm"></span></td>\n+'+
        ...
        newSection.html(
             ...
             '<td  style="width:40%;text-align: left;"><span id="ZbutovkaNamesm"></span> </td>\n+'+
             '<td style="width:10%;text-align: center;">мес</td>\n+'+
             '<td style="width:10%;text-align: center;">1</td>\n+'+
             '<td style="width:15%;text-align: center;"> <span id="Zbutovkasm"></span>  </td>\n+'+
             '<td style="width:15%;text-align: center;font-weight: bold;"></span></td>');
             $('#tablecalnew1').append(newSection);        
        ...
        newSection.html(
            ...
            '<td  style="width:40%;text-align: left;"><span id="ZbutovkaManipNamesm"></span> </td>\n+'+
            '<td style="width:10%;text-align: center;">рейс</td>\n+'+
            '<td style="width:10%;text-align: center;">2</td>\n+'+
            '<td style="width:30%;text-align: center;"> <span id="ZbutovkaManipsm"></span>  </td>');
            $('#tablecalnew1').append(newSection); 
         ...
         newSection.html(
            ...
            '<td style="width:10%;text-align: center;">мес</td>\n+'+
            '<td style="width:10%;text-align: center;">1</td>\n+'+
            '<td style="width:30%;text-align: center;"> <span id="BioTyalsm"></span>  </td>');
            $('#tablecalnew1').append(newSection); 
...
//====Монтаж фановой трубы под фундаментом, с выходом за границу фундамента на 1м. (без подключения) й.========/// 
    ...
    $('#ZGilsaNamesm').text(ZGilsaName); 
     ...
     newSection.html(
         ...
         '<td style="width:15%;text-align: center;font-weight: bold;"><span id="Zblock4sm"></span></td>\n+'+
     ...
     newSection.html(
         ...
         '<td style="width:15%;text-align: center;"><span id="ZOpalybkasm"></span></td>\n+'+
 ...
 var newSection = $('<tr class="tablbl2"></tr>');
     newSection.html(
         ...
         '<td  style="width:40%;text-align: left;"><span id="ZPiloMatNamesm"></span></td>\n+'+
         '<td style="width:10%;text-align: center;">м3</td>\n+'+
         '<td style="width:10%;text-align: center;"><span id="NPiloMatsm"></span></td>\n+'+
         '<td style="width:15%;text-align: center;"><span id="ZPiloMatsm"></span></td>\n+'+
         '<td style="width:15%;text-align: center;"></td>');
     $('#tablecalnew2').append(newSection);
    ...
    var NYtepPlv=0;
      ...
      if (TeploPr==1){
        ...
        newSection.html(
            ...
            '<td  style="width:40%;text-align: left;"><span id="ZYtepPlNamesm"></span></td>\n+'+
            '<td style="width:10%;text-align: center;">м2</td>\n+'+
            '<td style="width:10%;text-align: center;"><span id="NYtepPlsm"></span></td>\n+'+
            '<td style="width:15%;text-align: center;"><span id="ZYtepPlsm"></span></td>\n+'+
            '<td style="width:15%;text-align: center;"></td>');
        $('#tablecalnew2').append(newSection);
     ...
     if (TeploPr==1){
        ...
        newSection.html(
            ...
            '<td  style="width:40%;text-align: left;"><span id="ZGenoPolistirolNamesm"></span>  </td>\n+'+
            '<td style="width:10%;text-align: center;">шт</td>\n+'+
            '<td style="width:10%;text-align: center;"><span id="NGenoPolistirolsm"></span></td>\n+'+
            '<td style="width:15%;text-align: center;"> <span id="ZGenoPolistirolsm"></span>  </td>\n+'+
            '<td style="width:15%;text-align: center;"></td>');
            $('#tablecalnew2').append(newSection);
...
//====Утепление под плитой ========/// 
     ...
     if (TeploPr==1){
        ...
        newSection.html(
            ...
            '<td  style="width:40%;text-align: left;"><span id="ZYteplTorzNamesm"></span>  </td>\n+'+
            '<td style="width:10%;text-align: center;">м.п.</td>\n+'+
            '<td style="width:10%;text-align: center;"><span id="NYteplTorzsm"></span></td>\n+'+
            '<td style="width:15%;text-align: center;">  <span id="ZYteplTorzsm"></span>  </td>\n+'+
            '<td style="width:15%;text-align: center;"></td>'); 
            $('#tablecalnew2').append(newSection);
    ...
    else
    {
     ...
     if (TeploPr==1){
        ...
        newSection.html(
            ...
            '<td  style="width:40%;text-align: left;"><span id="ZGenoPolistirol2Namesm"></span>  </td>\n+'+
            '<td style="width:10%;text-align: center;">шт</td>\n+'+
            '<td style="width:10%;text-align: center;"><span id="NGenoPolistirol2sm"></span></td>\n+'+
            '<td style="width:15%;text-align: center;">  <span id="ZGenoPolistirol2sm"></span>  </td>\n+'+
            '<td style="width:15%;text-align: center;"></td>'); 
            $('#tablecalnew2').append(newSection);
     ...
     if (TeploPr==1){
        ...
        newSection.html(
            ...
            '<td  style="width:40%;text-align: left;"><span id="ZDubekTeplosmNamesm"></span>  </td>\n+'+
            '<td style="width:10%;text-align: center;">шт</td>\n+'+
            '<td style="width:10%;text-align: center;"><span id="NDubekTeplosm"></span></td>\n+'+
            '<td style="width:15%;text-align: center;">  <span id="ZDubekTeplosm"></span>  </td>\n+'+
            '<td style="width:15%;text-align: center;"></td>'); 
            $('#tablecalnew2').append(newSection);
     ...
     var newSection = $('<tr class="tablbl2"></tr>');
        newSection.html(
            ...
            '<td  style="width:40%;text-align: left;"><span id="ZKleyPolisNamesm"></span>  </td>\n+'+
            '<td style="width:10%;text-align: center;">шт</td>\n+'+
            '<td style="width:10%;text-align: center;">2</td>\n+'+
            '<td style="width:15%;text-align: center;"> <span id="ZKleyPolissm"></span>  </td>\n+'+
            '<td style="width:15%;text-align: center;"></td>'); 
            $('#tablecalnew2').append(newSection);
     ...
     newSection.html(
         ...
         '<td  style="width:40%;text-align: left;"><span id="ZGidroFundNamesm"></span>  </td>\n+'+
         '<td style="width:10%;text-align: center;">м2</td>\n+'+
         '<td style="width:10%;text-align: center;"><span id="NGidroFundsm"></span></td>\n+'+
         '<td style="width:15%;text-align: center;"> <span id="ZGidroFundsm"></span> </td>\n+'+
         '<td style="width:15%;text-align: center;"></td>'); 
         $('#tablecalnew2').append(newSection);
     ...
     newSection.html(
         ...
         '<td  style="width:40%;text-align: left;"><span id="ZVjzkaD12Namesm"></span>  </td>\n+'+
         '<td style="width:10%;text-align: center;">кг</td>\n+'+
         '<td style="width:10%;text-align: center;"><span id="NVjzkaD12sm"></span></td>\n+'+
         '<td style="width:15%;text-align: center;"> <span id="ZVjzkaD12sm"></span> </td>\n+'+
         '<td style="width:15%;text-align: center;"></td>'); 
         $('#tablecalnew2').append(newSection);
   ...
   var F22=F17+F20;  
     ...
     newSection.html(
         ...
         '<td  style="width:40%;text-align: left;"><span id="ZArmatura65Namesm"></span> </td>\n+'+
         '<td style="width:10%;text-align: center;">кг</td>\n+'+
         '<td style="width:10%;text-align: center;"><span id="NArmatura65sm"></span></td>\n+'+
         '<td style="width:15%;text-align: center;"> <span id="ZArmatura65sm"></span> </td>\n+'+
         '<td style="width:15%;text-align: center;"></td>'); 
         $('#tablecalnew2').append(newSection);
     ...
     newSection.html(
         ...
         '<td  style="width:40%;text-align: left;"><span id="ZKrepegNamesm"></span> </td>\n+'+
         '<td style="width:10%;text-align: center;">м2</td>\n+'+
         '<td style="width:10%;text-align: center;"><span id="NKrepegsm"></span> </td>\n+'+
         '<td style="width:15%;text-align: center;"> <span id="ZKrepegsm"></span> </td>\n+'+
         '<td style="width:15%;text-align: center;"></td>'); 
         $('#tablecalnew2').append(newSection);
    ...
    //  NArmatura65v=Math.round(NArmatura65v);     
     ...
     newSection.html(
         ...
         '<td  style="width:40%;text-align: left;"><span id="ZBetonFundNamesm"></span> </td>\n+'+
         '<td style="width:10%;text-align: center;">м3</td>\n+'+
         '<td style="width:10%;text-align: center;"><span id="NBetonFundsm"></span></td>\n+'+
         '<td style="width:15%;text-align: center;"> <span id="ZBetonFundsm"></span> </td>\n+'+
         '<td style="width:15%;text-align: center;"></td>'); 
         $('#tablecalnew2').append(newSection);
      var I19=2;
      var C17=document.getElementById('thickness').value; 
    ...
    newSection.html(
        ...
        '<td  style="width:40%;text-align: left;"><span id="ZBetonM400Namesm"></span> </td>\n+'+
        '<td style="width:10%;text-align: center;">м3</td>\n+'+
        '<td style="width:10%;text-align: center;"><span id="NBetonM400sm"></span></td>\n+'+
        '<td style="width:15%;text-align: center;"> <span id="ZBetonM400sm"></span> </td>\n+'+
        '<td style="width:15%;text-align: center;"></td>'); 
        $('#tablecalnew2').append(newSection);
    ...
    newSection.html(
        ...
        '<td  style="width:40%;text-align: left;"><span id="ZMikserNamesm"></span> </td>\n+'+
        '<td style="width:10%;text-align: center;">м3</td>\n+'+
        '<td style="width:10%;text-align: center;"><span id="NMiksersm"></span></td>\n+'+
        '<td style="width:15%;text-align: center;"> <span id="ZMiksersm"></span> </td>\n+'+
        '<td style="width:15%;text-align: center;"></td>'); 
        $('#tablecalnew2').append(newSection);
    ...
    k=k+1
     ...
     newSection.html(
         ...
         '<td  style="width:40%;text-align: left;"><span id="ZNasosNamesm"></span> </td>\n+'+
         '<td style="width:10%;text-align: center;">смена</td>\n+'+
         '<td style="width:10%;text-align: center;"><span id="NNasossm"></span></td>\n+'+
         '<td style="width:15%;text-align: center;"> <span id="ZNasossm"></span> </td>\n+'+
         '<td style="width:15%;text-align: center;"></td>'); 
         $('#tablecalnew2').append(newSection);
     var NNasosv=1;
     if (NBetonFundv<70){
     ...
     newSection.html(
         ...
         '<td  style="width:40%;text-align: left;"><span id="ZDostavkaRachodNamesm"></span> </td>\n+'+
         '<td style="width:10%;text-align: center;">рейс</td>\n+'+
         '<td style="width:10%;text-align: center;">1</td>\n+'+
         '<td style="width:15%;text-align: center;"> <span id="ZDostavkaRachodsm"></span> </td>\n+'+
         '<td style="width:15%;text-align: center;"></td>'); 
         $('#tablecalnew2').append(newSection);
     ...
     newSection.html(
       ...
       if (DrenagPr==1){
        ...
        newSection.html(
            ...
            '<td style="width:15%;text-align: center;font-weight: bold;"><span id="Zblock5sm"></span></td>\n+'+
            '<td style="width:15%;text-align: center;font-weight: bold;"></td>');
       ...
       newSection.html(
           ...
           '<td  style="width:40%;text-align: left;"><span id="ZDorabTrNamesm"></span> </td>\n+'+
           '<td style="width:10%;text-align: center;">м.п.</td>\n+'+
           '<td style="width:10%;text-align: center;"><span id="NDorabTrsm"></span></td>\n+'+
           '<td style="width:15%;text-align: center;"> <span id="ZDorabTrsm"></span> </td>\n+'+
           '<td style="width:15%;text-align: center;"></td>'); 
           $('#tablecalnew3').append(newSection);
     ...
     $('#NumberBl52sm').text(NumberBl+'.'+n);
      ...
      newSection.html(
          ...
          '<td  style="width:40%;text-align: left;"><span id="ZUkladkaDrenagTrNamesm"></span> </td>\n+'+
          '<td style="width:10%;text-align: center;">м.п.</td>\n+'+
          '<td style="width:10%;text-align: center;"><span id="NUkladkaDrenagTrsm"></span></td>\n+'+
          '<td style="width:15%;text-align: center;"> <span id="ZUkladkaDrenagTrsm"></span> </td>\n+'+
          '<td style="width:15%;text-align: center;"></td>'); 
          $('#tablecalnew3').append(newSection);
      ...
      newSection.html(
          ...
          '<td  style="width:40%;text-align: left;"><span id="ZDrenagTr110Namesm"></span> </td>\n+'+
          '<td style="width:10%;text-align: center;">м.п.</td>\n+'+
          '<td style="width:10%;text-align: center;"><span id="NDrenagTr110sm"></span></td>\n+'+
          '<td style="width:15%;text-align: center;"> <span id="ZDrenagTr110sm"></span> </td>\n+'+
          '<td style="width:15%;text-align: center;"></td>'); 
          $('#tablecalnew3').append(newSection);
      ...
      newSection.html(
          ...
          '<td  style="width:40%;text-align: left;"><span id="ZMontagKolNamesm"></span> </td>\n+'+
          '<td style="width:10%;text-align: center;">шт</td>\n+'+
          '<td style="width:10%;text-align: center;">4</td>\n+'+
          '<td style="width:15%;text-align: center;"> <span id="ZMontagKolsm"></span> </td>\n+'+
          '<td style="width:15%;text-align: center;"></td>'); 
          $('#tablecalnew3').append(newSection);
      ...
      newSection.html(
          ...
          '<td  style="width:40%;text-align: left;"><span id="ZKolodezNamesm"></span>  </td>\n+'+
          '<td style="width:10%;text-align: center;">шт</td>\n+'+
          '<td style="width:10%;text-align: center;">4</td>\n+'+
          '<td style="width:15%;text-align: center;"> <span id="ZKolodezsm"></span>  </td>\n+'+
          '<td style="width:15%;text-align: center;"></td>'); 
          $('#tablecalnew3').append(newSection);
     ...
     var newSection = $('<tr class="tablbl3"></tr>');
      newSection.html(
          ...
          '<td  style="width:40%;text-align: left;"> <span id="ZShebObratNamesm"></span>  </td>\n+'+
          '<td style="width:10%;text-align: center;">м.п.</td>\n+'+
          '<td style="width:10%;text-align: center;"><span id="NShebObratsm"></span></td>\n+'+
          '<td style="width:15%;text-align: center;">  <span id="ZShebObratsm"></span>  </td>\n+'+
          '<td style="width:15%;text-align: center;"></td>'); 
          $('#tablecalnew3').append(newSection);
