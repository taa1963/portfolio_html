   ...
   function ClLi(element) {
    ...
    function selectadd(){
       ...
       // if (typeauction=='copart'){
            ...
            var url = "https://aleksandr.tupichenkov.com/CalcExel_Tabl/js/Price.xlsx";
                       ...
                       // var TR = desired_cell.v;
                        ...
                        if(Name1.indexOf('1#') === 0) {
                            ...
                            $(' <ul class="first_level">' +
                                ' <li class="first_level_sp">  <span class="sp1" onclick="ClSp1(this);" >+</span> '+Name2+' <span>+nameauction[i]+Name2</span>')
                                .appendTo(opt12);
                        ...
                        if(Name1.indexOf('2#') === 0) {
                            ...
                            $('  <ul class="second_level">' +
                               ' <li><span class="sp2" onclick="ClSp2(this);">+</span> '+Name2+' 1Бетоны на заполнителях из пористых горных пород</li>')
                                .appendTo(opt12);
                             }
                        ...
                        if(Name1.indexOf('3#') === 0) {
                            if (level2==0){
                                ...
                                $('<ul class="third_level">' +
                                    '<li class="sp3l"><span class="sp3" onclick="ClSp3(this);" >+</span> '+Name2+' 1Бетон на вулканическом шлаке</li>'+
