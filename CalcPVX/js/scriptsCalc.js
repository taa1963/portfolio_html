...
//    let C5=0;
//       $('.priceallbl').each(function(){
//         C5 += parseFloat($(this).val())
//     });
  
// document.getElementById('itog_all_pr').value=C5;
// let C5nds=(C5/100)*20;

// document.getElementsByClassName('itog_all_NDC').value=C5nds;
...
if (montagval>0){
 ...
 newSection.html(       
   ...
   newSection.html(       
       ...
       '<td class="table_cell" style="width:10%;"> <input type="text" class="cell_select" value="" readonly ></td>\n'+ 
       '<td class="table_cell" style="width:40%;"> <input type="text" class="cell_select" value="Итого" readonly ></td>\n'+ 
       '<td class="table_cell" style="width:15%;"> <input type="text" class="cell_select" value="" readonly ></td>\n'+ 
       '<td class="table_cell" style="width:15%;"> <input type="text" class="cell_select" value="" readonly ></td>\n'+  
       '<td class="table_cell" style="width:15%;"> <input type="text" class="cell_select" value="" readonly ></td>\n'+ 
   ...
   newSection.html(       
       ...
       '<td class="table_cell" style="width:10%;"> <input type="text" class="cell_select" value="" readonly ></td>\n'+ 
       '<td class="table_cell" style="width:40%;"> <input type="text" class="cell_select" value="В том числе НДС 20%" readonly ></td>\n'+ 
       '<td class="table_cell" style="width:15%;"> <input type="text" class="cell_select" value="" readonly ></td>\n'+ 
       '<td class="table_cell" style="width:15%;"> <input type="text" class="cell_select" value="" readonly ></td>\n'+  
       '<td class="table_cell" style="width:15%;"> <input type="text" class="cell_select" value="" readonly ></td>\n'+ 
