...
//========== Определение типа фундамента =======================================//
   ...
   /* function type_fund2() {
        if (document.getElementById('fundNew').checked){
            var block = $(this).parents('.zakas_block2');
            block.find('.calcbut').show();
        }
     ...
     $('#fundNew').click(function () {

         if (document.getElementById('fundNew').checked){
             var div = document.getElementById('calcbut');
             div.style.display.inline;
             $('.calcbut').css('display','inline');
             // var block = $(this).parents('.zakas_block2');
             // block.find('.calcbut').style(dis);
